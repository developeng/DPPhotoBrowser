...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of DPPhotoBrowser."
  ...
  # Or just: spec.author    = "developeng"
  # spec.authors            = { "developeng" => "developeng@163.com" }
  # spec.social_media_url   = "https://twitter.com/developeng"
  ...
  spec.dependency "Kingfisher", "~> 6.0.1"
